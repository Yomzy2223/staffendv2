...
const Wrapper = ({
  ...
  let status =
    selectedOverview && selectedOverview !== "all" ? selectedOverview : "";
  ...
  const description =
    (activeService || "All requests") +
    " " +
    (selectedOverview ? status : "revenue") +
    " between ";
  ...
  return (
    ...
    >
      <div>
        <p className="sb-text-24 font-semibold mb-1 lowercase first-letter:uppercase">
          {title}
        </p>
        <div>
